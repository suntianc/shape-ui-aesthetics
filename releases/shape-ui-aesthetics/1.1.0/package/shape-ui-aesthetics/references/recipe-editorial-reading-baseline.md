...
| Body line-height | Latin 1.4–1.75, coupled to size (16px → 1.4–1.5; 22px → 1.65); **CJK body 1.7–2.0** (square glyphs lack ascenders and descenders, so return sweeps need extra leading to compensate) | <1.3; large size with tight leading (22/1.2) | pudding.cool 1.4, frankchimero.com and joshwcomeau.com 1.5, ia.net 1.65, paco.me token 1.75; the CJK band comes from Chinese book-setting convention plus a KOReader trial at 17px × 1.9 that passed human review (2026-07-26) — no corpus-site measurement yet; backfill when a CJK corpus site is available |
| Measure (content column width) | 576–720px (≈60–80 characters at 16px) | Text running the full container; >90 characters | frankchimero.com `--spacing-col: 36rem` (576), paco.me `--content-width: 640px`, pudding.cool `--width-column-regular: 720px` |
