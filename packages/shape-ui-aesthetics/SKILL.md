...
Record the artifact, Change Boundary, user and core task, real content, protected functionality, required states and devices, explicit musts, and prohibitions. Inspect existing artifacts before changing them. Do not choose a layout, style, or rendering medium while the frame is still unclear.
...
Present a single authored design, implementation, refinement, or review. State the governing thesis, consequential decisions, visible result, preserved constraints, and unresolved human choices or validation obligations. Do not expose a catalogue of capabilities, a routing transcript, stitched specialist reports, provenance, or a numerical beauty score.
